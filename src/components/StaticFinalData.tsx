    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-7xl">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-[#820000] mb-2">Spring 2025 Final Exam Schedule</h1>
            ...
            <Tabs defaultValue="thursday" className="w-full">
                <TabsList className="grid grid-cols-4 md:grid-cols-8 mb-6 w-full">
                    <TabsTrigger value="thursday" className="md:col-span-2 data-[state=active]:bg-[#820000] data-[state=active]:text-white">
                        Thursday<Badge className="ml-2 bg-[#f8e2e4] text-[#820000]">{thursdayExams.length}</Badge>
                    </TabsTrigger>
                    <TabsTrigger value="friday" className="md:col-span-2 data-[state=active]:bg-[#820000] data-[state=active]:text-white">
                        Friday<Badge className="ml-2 bg-[#f8e2e4] text-[#820000]">{fridayExams.length}</Badge>
                    </TabsTrigger>
                    <TabsTrigger value="monday" className="md:col-span-2 data-[state=active]:bg-[#820000] data-[state=active]:text-white">
                        Monday<Badge className="ml-2 bg-[#f8e2e4] text-[#820000]">{mondayExams.length}</Badge>
                    </TabsTrigger>
                    <TabsTrigger value="tuesday" className="md:col-span-2 data-[state=active]:bg-[#820000] data-[state=active]:text-white">
                        Tuesday<Badge className="ml-2 bg-[#f8e2e4] text-[#820000]">{tuesdayExams.length}</Badge>
                    </TabsTrigger>
                </TabsList>
