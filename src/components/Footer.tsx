    ...
    <footer className="w-full bg-gray-50 border-t py-6">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center space-x-6 w-full max-w-2xs">
            <Link 
            ...
            <p className="text-sm text-gray-600">Disclaimer: This website is student made. Double check any final exam information on the official Aggie One Stop website. </p>
          </div>
        </div>
